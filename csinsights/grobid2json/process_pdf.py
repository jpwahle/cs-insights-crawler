...
from csinsights.grobid2json.grobid.grobid_client import GrobidClient
from csinsights.grobid2json.tei_to_json import (
...
def process_pdf_file(
    ...
    with open(output_file, "w") as outf:
        json.dump(paper.release_json(), outf, sort_keys=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--temp", default=BASE_TEMP_DIR, help="path to the temp dir for putting tei xml files"
    )
    parser.add_argument(
        "-o",
        "--output",
